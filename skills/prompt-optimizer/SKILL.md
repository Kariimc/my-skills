...
description: >-
  ...
  prompt. Advisory only — never executes the task itself.
  TRIGGER when the user says "optimize prompt", "improve my prompt",
  "how to write a prompt for", "help me prompt", "rewrite this prompt",
  or Chinese equivalents ("优化prompt", "改进prompt", "怎么写prompt").
  DO NOT TRIGGER when the user wants the task executed directly ("just
  do it"), or says "optimize performance" / "optimize this code" /
  "优化代码" — those are refactoring tasks, not prompt optimization.
metadata:
  origin: community
  author: YannJY02
  version: "1.0.0"
