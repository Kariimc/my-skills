...
|---|---|---|
| [`skills/`](./skills/) | `~/.claude/skills/` | 424 skills, one folder each (`skills/<name>/SKILL.md`). See [the catalog](./skills/README.md). |
...
- **Catalog:** [`skills/README.md`](./skills/README.md) — all 424 skills by category.
