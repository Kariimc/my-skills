...
**Scale (verified live, not claimed):** 424 skills · 73 subagents · 4 slash
...
| 3 | **The skill library** — the toys | `skills/`, `agents/`, `commands/`, `rules/` | 424 skills + 73 agents + commands + rules Claude actually uses. | sync + doctor |
...
apex  (immune system — gates on commit/push/CI, ratchet, self-integrity)
  └── six harnesses  (Build · Quality · Research · Audit · Autonomous · Refactor)
        └── skill-ship  (skill-doctor + skill-ship skill = how the repo mutates)
              └── skill library  (424 skills · 73 agents · commands · rules)
```
